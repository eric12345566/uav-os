...
def transferLocationID3(x):
    return {
        ...
        '19': (0, -30), '21': (60, -30), '22': (90, -30), '23': (120, -30),
        '24': (150, -30), '25': (180, -30), '26': (210, -30), '27': (240, -30), '28': (270, -30),
        '29': (300, -30), '30': (330, -30), '31': (360, -30), '32': (420, -30), '33': (450, -30),
        '34': (480, -30), '35': (510, -30), '36': (540, -30), '37': (570, -30),
         '40': (60, -60), '41': (90, -60), '42': (480, -60), '43': (510, -60), '44': (540, -60),
        '45': (570, -60), '47': (90, -120), '48': (60, -90), '49': (90, -90), '50': (150, -90),
        ...
        '157': (570, -270), '38': (483, -90), '46': (483, -120), '160': (483, -150), '161': (483, -180),
        '162': (90, -90), '20':(90, -120), '39':(90, -150)
    }[x]
